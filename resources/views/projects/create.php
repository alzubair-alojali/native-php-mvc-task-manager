<?php
$title = 'Create Project - Web Final Project';
...
<div class="mb-8">
    ...
    <h1 class="text-2xl font-bold text-slate-900 sm:text-3xl">Create New Project</h1>
...
<div class="mx-auto max-w-2xl">
    <div class="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-900/5">
        <form action="/web_final_project/public/projects/create" method="POST" class="space-y-6">
