...
<div class="rounded-2xl bg-white p-6 sm:p-8 shadow-sm ring-1 ring-slate-900/5 mb-8">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <a href="<?= base_url('/tasks/create?project_id=' . $project['id']) ?>"
            ...
            <a href="<?= base_url('/projects/edit?id=' . $project['id']) ?>"
            ...
            <form action="<?= base_url('/projects/delete') ?>" method="POST" class="inline"
