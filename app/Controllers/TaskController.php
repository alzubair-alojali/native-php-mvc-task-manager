...
class TaskController extends Controller
{
    ...
    public function store()
    {
        ...
        if ($taskId) {
            ...
            header("Location: " . base_url('/tasks?project_id=' . $projectId));
            exit;
        } else {
            $_SESSION['error'] = 'Failed to create task. Please try again.';
            header("Location: " . base_url('/tasks/create?project_id=' . $projectId));
            exit;
        }
    }
    ...
    public function updateStatus()
    {
        ...
        if ($taskModel->updateStatus($id, $status)) {
            ...
            header("Location: " . base_url('/tasks?project_id=' . $task['project_id']));
            exit;
        } else {
